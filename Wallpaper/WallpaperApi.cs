...
{
    // Taken from
    // https://pulse.codeplex.com/SourceControl/changeset/view/72677#Pulse/Providers/WinAPI/Desktop.cs
    ...
    public class WallpaperApi
    {
        ...
        public static void SetAeroColor(Color newColor)
        {
            if (WinApi.DwmIsCompositionEnabled())
            {
                ...
                color.ColorizationColor = (uint)Color.FromArgb(255, newColor.R, newColor.G, newColor.B).ToArgb();
                //transition
